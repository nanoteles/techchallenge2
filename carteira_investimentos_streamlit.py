...
# --- Funções do Algoritmo Genético (sem modificações) ---
...
# --- 3. Execução do Algoritmo Genético (Modificado para exibir no Streamlit) ---
def rodar_algoritmo_genetico(ativos_df, valor_total, risco_maximo, data_retirada, num_ativos_desejados, progress_bar, qtd_geracoes=200, tamanho_populacao=100, taxa_mutacao=0.1, num_elite=5):
    ...
    for geracao in range(qtd_geracoes):
        ...
        status_text.text(f"Geração {geracao}/{qtd_geracoes} - Melhor Fitness: {melhor_fitness_geral:.4f}")
...
# --- 4. Apresentação dos Resultados (Modificado para exibir no Streamlit) ---
...
# --- Função Principal com a Interface Streamlit ---
def main():
